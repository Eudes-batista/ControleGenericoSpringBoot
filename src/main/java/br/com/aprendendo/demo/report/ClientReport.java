package br.com.aprendendo.demo.report;
...
public class ClientReport {
     ...
     public static ByteArrayInputStream clientReport(List<Cliente> clientes) {
        ...
        try {
            ...
            for (Cliente cliente : clientes) {
                ...
                cell = new PdfPCell(new Phrase(cliente.getTelefone()));
                ...
                cell = new PdfPCell(new Phrase(String.valueOf(cliente.getEndereco())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
